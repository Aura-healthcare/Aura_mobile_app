/**
 * @file GattSetNotificationOperation.java
...
public class GattSetNotificationOperation extends GattOperation {
    ...
    public GattSetNotificationOperation(GattManager iGattManager, BluetoothDevice device, UUID serviceUuid, UUID characteristicUuid, UUID descriptorUuid) {
        super(device);
        mGattManager = iGattManager;
